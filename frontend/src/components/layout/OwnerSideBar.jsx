...
import "../../styles/Common/adminSideBar.css"; // Assuming common sidebar styling
...
const Item = ({ to, icon, label }) => (
  <li>
    <NavLink
      ...
      end={to === "/dashboard/owner"} // Changed to /dashboard/owner
    >
      <Icon path={icon} />
      <span>{label}</span>
    </NavLink>
    ...
    <aside className="asb__wrapper">
      ...
      <nav className="asb__nav">
        <ul className="asb__top">
          <Item to="/dashboard/owner" icon={icons.dashboard} label="Dashboard" />
        </ul>
        ...
        <Section title="User Management">
          <Item to="/admin/usermanagement" icon={icons.users} label="Manage Users" />
        </Section>
